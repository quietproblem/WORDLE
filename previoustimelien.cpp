...
const char *darkGreyColorCode = "\033[0;90m";
...
void printABC()
{
    ...
    for (int i = 0; i < 26; i++)
    {
        ...
        {
            cout << darkGreyColorCode << abc[i].letter <<" "<< resetColorCode;
        }
        if (i == 9)
        {
            cout << endl
        ...
        for (int i = 0; i < guesses.size(); i++)
        {
            ...
            for (int j = 0; j < 5; j++)
            {
                ...
                else
                {
                    ...
                    modifyLetter(guesses.at(i).name[j], DARK_GREY, abc);
                }
            }
            cout << endl;
        }
